...
export const options = {
  stages: [
    { duration: '30s', target: 5000 }, // Sobe gradualmente até 5.000 VUs
    { duration: '1m', target: 5000 },  // Mantem 5.000 VUs por 1 minuto
    { duration: '30s', target: 5000 }, // Mantem carga em 5.000 VUs
    { duration: '1m', target: 5000 },  // Mantem 5.000 VUs por mais 1 minuto
...
export function handleSummary(data) {
  ...
  return {
    'stdout': `
==================================================
        RELATORIO DE PERFORMANCE - K6 (20k QPS)
==================================================
